...
class InvoiceMaster extends Model
{
	...
	public function InvoiceDetail(){
		return $this->hasMany('App\Model\InvoiceDetail', 'invoice_id', 'id');
	}

	public function InvoiceMonths(){
		return $this->hasMany('App\Model\InvoiceMonth', 'invoice_id', 'id');
	}
	...
	public function scopeUnPaid($query){
        ...
        $q->where('date_of_payment', '0000-00-00')
          ->orWhereNull('date_of_payment');
    });
	}
