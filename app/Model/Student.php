...
*/
	...
	{
		return $this->hasOne('App\Model\ParentInterview');
	}
	...
	{
		return $this->belongsTo('App\Model\AcademicSession', 'session_id');
	}
	...
	{
		return $this->hasMany('App\Model\AdditionalFee');
	}
	...
	{
		return $this->hasOne('App\Model\StudentAttendance');
	}

	public function Invoices()
	{
		return $this->hasMany('App\Model\InvoiceMaster');
	}

	public function InvoiceMonths()
	{
		return $this->hasMany('App\Model\InvoiceMonth');
	}
	...
	{
		return $this->hasOne('App\Model\InvoiceMaster')->orderBy('id', 'desc');
	}

	public function dueInvoice()
	{
		return $this->hasOne('App\Model\InvoiceMaster')->unPaid()->orderBy('created_at', 'desc');
		// return $this->hasOne('App\Model\InvoiceMaster')->where('paid_amount', '0')->orderBy('created_at', 'desc');		
	}
