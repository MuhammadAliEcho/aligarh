@extends('admin.layouts.master')
  ...
  @section('title', __('modules.pages_edit_employee_title').' |')
               ...
               <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h2>{{ __('modules.forms_edit_employee') }}</h2>
                                      ...
                                      <div class="form-group{{ ($errors->has('phone'))? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                          <div class="input-group m-b">
                                            ...
                                            <input type="text" name="phone" value="{{ old('phone', $employee['phone']) }}" placeholder="{{ __('labels.contact_no_placeholder') }}" class="form-control" data-mask="9999999999"/>
                                          </div>
                                          @if ($errors->has('phone'))
                                              <span class="help-block">
