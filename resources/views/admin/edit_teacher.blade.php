                    ...
                    <div class="ibox-content">
                                    ...
                                    <form id="tchr_rgstr" method="post" action="{{ URL('teacher/edit/'.$teacher['id']) }}" class="form-horizontal" enctype="multipart/form-data" >
                                      ...
                                      <div class="form-group{{ ($errors->has('img'))? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                          <img id="img" src="{{ URL($teacher->image_url) or '' }}"  alt="Item Image..." class="img-responsive img-thumbnail" />
                                          @if ($errors->has('img'))
                                              <span class="help-block">
                                      ...
                                      <div class="form-group{{ ($errors->has('phone'))? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                          <input type="text" name="phone" value="{{ old('phone', $teacher['phone']) }}" placeholder="Contact No" class="form-control" data-mask="(999) 999-9999"/>
                                          @if ($errors->has('phone'))
                                              <span class="help-block">
