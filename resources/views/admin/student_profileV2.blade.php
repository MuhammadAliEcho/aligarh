...
<!--                         <img src="{{ URL($student->image_url) }}" class="img-circle circle-border m-b-md" alt="profile"> -->
                        <img src="{{ URL(($student->image_url == '')? 'img/avatar.jpg' : $student->image_url) }}" class="img-circle circle-border m-b-md" alt="profile">
                    </div>
                    <div class="profile-info">
                        <div class="">
                            <div>
                                ...
                                <h4>{{ $student->Std_Class->name." (".$student->Section->nick_name."). GR.".$student->gr_no }}</h4>
                                <small>
                                  {{ $student->address }}
                                </small>
                            </div>
                ...
                <div class="col-md-5">
                    <table class="table small m-b-xs">
                        ...
                        <tr>
                            ...
                            <td>
                                <strong>Place Of Birth</strong> {{ $student->place_of_birth }}
                            </td>
