            ...
            <div class="row m-b-lg m-t-lg">
                <div class="col-md-4">
                    ...
                    <div class="profile-image">
                        <img src="{{ URL($teacher->image_url) }}" class="img-circle circle-border m-b-md" alt="profile">
<!--                         <img src="{{ URL($teacher->image_url) }}" class="img-thumbnail m-b-md" alt="profile"> -->
                    </div>
                    <div class="profile-info">
                        <div class="">
                            <div>
                                ...
                                <h4>{{ $teacher->subject }} </br> {{ $teacher->email }} </h4>
                                <small>
                                  {{ $teacher->address }}
                                </small>
                            </div>
