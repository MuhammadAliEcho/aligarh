...
@section('title', __('modules.pages_teachers_attendance_title').' |')
                        ...
                        <div class="tab-content">
                            <div id="tab-10" class="tab-pane fade make-attendance">
                                <div class="panel-body" style="min-height: 400px">
                                    ...
                                    <form id="mk_att_frm" method="GET" action="{{ URL('teacher-attendance/make') }}"
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-offset-2 col-md-6">
                                                <button class="btn btn-primary" type="submit"><span
                                                        class="glyphicon glyphicon-save"></span> Make Attendence </button>
                                            </div>
                                        </div>
                                            ...
                                            <form action="{{ URL('teacher-attendance/make') }}" method="POST">
                                                    ...
                                                    <tbody>
                                                        @foreach ($teachers as $teacher)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="hidden"
                                                                        name="teacher_id[{{ $teacher->id }}]"
                                                                        value="{{ $teacher->id }}">
                                                                    <input type="hidden"
                                                                        name="teacher_leave[{{ $teacher->id }}]"
                                                                        value="{{ $teacher->leaveOnDate->id ?? null }}">
                                                                    <div class="checkbox checkbox-success">
                                                                        <input id="checkbox{{ $teacher->id }}"
                                                                            class="selectAtt" type="checkbox"
                                                                            name="attendance{{ $teacher->id }}"
                                                                            value="1"
                                                                            {{ isset($attendance[$teacher->id]->status) && $attendance[$teacher->id]->status ? 'checked' : '' }} />
                                                                        <label for="checkbox{{ $teacher->id }}">
                                                                            @if ($teacher->leaveOnDate ?? false)
                                                                                <span title="Leave"
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-offset-4 col-md-4">
                                                        <button class="btn btn-primary" type="submit"><span
                                                                class="glyphicon glyphicon-save"></span> Make Attendence
                                                        </button>
                                                    </div>
                                                </div>
                            ...
                            @can('teacher-attendance.report')
                                <div id="tab-11" class="tab-pane fade get-attendance">
                                    <div class="panel-body" style="min-height: 400px">
                                        ...
                                        <form id="rpt_att_frm" method="GET" action="{{ URL('teacher-attendance/report') }}"
                                            class="form-horizontal jumbotron" role="form">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="table-responsive">
                                                    <table id="rpt-att"
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <td style="text-align: center;">Teachers<i
                                                        ...
                                                        <tbody>
                                                            @foreach ($teachers as $teacher)
                                                                <tr>
                                                                    ...
                                                                    @for ($i = 1; $i <= $dbdate['noofdays']; $i++)
                                                                        <th
                                                                            class="tchr_{{ $teacher->id }}_dat_{{ $i }}">
                                                                        </th>
                                                                    @endfor
                                                                </tr>
                                                            @endforeach
