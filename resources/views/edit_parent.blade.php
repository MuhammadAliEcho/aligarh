               ...
               <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                                    ...
                                    <form id="tchr_rgstr" method="post" action="{{ URL('parents/edit/'.$parent['id']) }}" class="form-horizontal" >
                                      {{ csrf_field() }}

                                      <div class="form-group{{ ($errors->has('name'))? ' has-error' : '' }}">
                                        <label class="col-md-2 control-label">Name</label>
                                        <div class="col-md-6">
                                          <input type="text" name="name" placeholder="Name" value="{{ old('name', $parent['name']) }}" class="form-control"/>
                                          @if ($errors->has('name'))
                                      ...
                                      <div class="form-group{{ ($errors->has('email'))? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                          <input type="text" name="email" placeholder="E-Mail" value="{{ old('email', $parent['email']) }}" class="form-control"/>
                                          @if ($errors->has('email'))
                                              <span class="help-block">
                                      ...
                                      <div class="form-group{{ ($errors->has('profession'))? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                          <input type="text" name="profession" placeholder="Profession" value="{{ old('profession', $parent['profession']) }}" class="form-control"/>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                          <textarea type="text" name="address" placeholder="Address" class="form-control">{{ old('address', $parent['address']) }}</textarea>
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group{{ ($errors->has('phone'))? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                          <input type="text" name="phone" value="{{ old('phone', $parent['phone']) }}" placeholder="Contact No" class="form-control" data-mask="(999) 999-9999"/>
                                          @if ($errors->has('phone'))
                                              <span class="help-block">
                                      ...
                                      <div class="form-group{{ ($errors->has('income'))? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                          <input type="text" name="income" value="{{ old('income', $parent['income']) }}" placeholder="Income" class="form-control"/>
